...
import TrainerForm from "@/components/panel/main-buttons/create-session/session-form/TrainerForm";
import CreateNewSession from "@/components/panel/main-buttons/create-session/_index";
import GameInfo from "@/components/panel/main-buttons/game-info/_index";
import Settings from "../components/panel/main-buttons/settings/_index";
