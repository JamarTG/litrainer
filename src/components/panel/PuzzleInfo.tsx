...
const PuzzleInfo = () => {
  ...
  return (
    <div className="w-full flex sm:flex-row items-center justify-center sm:items-start">
        ...
        {playedMove && classification ? (
          <div className="flex flex-row justify-center items-center h-full xl:justify-center xl:items-center xl:flex-col gap-2">
            <small className="text-sm text-gray-800">
              ...
              {classification && <span className="ml-2 text-base font-semibold text-purple-900">({classification})</span>}
            </small>
