 ...
 */ !(function () {
    ...
    function e(e) {
      ...
      (e = e || {}),
        ...
        (i.postCustomMessage = function (e) {
          if (void 0 !== g) for (var t of g.za) t.postMessage({ cmd: "custom", userData: e });
        }),
        (i.queue =
          ((q = []),
          {
      ...
      if (s) {
        var a = o ? require("path").dirname(a) + "/" : __dirname + "/",
          ...
          X = function (e) {
            return re((e = (e = K(e, !0)).buffer ? e : new Uint8Array(e)).buffer), e;
          };
            ...
            : ((K = function (e) {
              ...
              o &&
                (X = function (e) {
                  var t = new XMLHttpRequest();
                  return (
                    t.open("GET", e, !1), (t.responseType = "arraybuffer"), t.send(null), new Uint8Array(t.response)
                  );
                })));
      ...
      "undefined" != typeof TextDecoder && new ae("utf-16le"), l && (fe = i.buffer);
      var f = i.INITIAL_MEMORY || 536870912;
      if (l) (u = i.wasmMemory), (fe = i.buffer);
      else if (i.wasmMemory) u = i.wasmMemory;
      else if (
        !(
          (u = new WebAssembly.Memory({ initial: f / 65536, maximum: f / 65536, shared: !0 })).buffer instanceof
          SharedArrayBuffer
        )
      )
        throw (
      ...
      function we() {
        ...
        m--,
          ...
          0 == m && (null !== _e && (clearInterval(_e), (_e = null)), ye) && ((e = ye), (ye = null), e());
      }
      function y(e) {
        throw (
      ...
      (i.preloadedImages = {}), (i.preloadedAudios = {}), (p = "stockfish-nnue-16.wasm"), ve() || (p = Q(p));
      var Ae = {
        30597: function () {
          throw "Canceled!";
        }
      ...
      function xe(e, t) {
        ...
        var n = Atomics.load(_, x >> 2),
          r = 0;
        if (n == e && Atomics.compareExchange(_, x >> 2, n, 0) == n && ((r = 1), --t <= 0)) return 1;
      ...
      var g = {
        ...
        hb: function () {
          ...
          Atomics.store(C, (e + 100) >> 2, n), Atomics.store(C, (e + 40) >> 2, e), Rt(e, !o, 1), Mt(e);
        },
        ib: function () {
        ...
        Sa: function () {
          ...
          for (g.Aa = [], e = 0; e < g.za.length; ++e) (t = (n = g.za[e]).wa), g.Qa(t), n.terminate();
          g.za = [];
        },
        Qa: function (e) {
          var t;
          e &&
            (e.ya && ((t = _[(e.ya + 100) >> 2]), (_[(e.ya + 100) >> 2] = 0), A(t), A(e.ya)),
            (e.ya = 0),
            e.Pa && e.Ba && A(e.Ba),
            (e.Ba = 0),
            e.worker) &&
        ...
        La: function (e) {
          g.mb(function () {
            delete g.xa[e.wa.ya], g.Aa.push(e), g.za.splice(g.za.indexOf(e), 1), g.Qa(e.wa), (e.wa = void 0);
          });
        },
        mb: function (e) {
          _[Yt >> 2] = 0;
        ...
        jb: function (a, o) {
          (a.onmessage = function (e) {
            var t = e.data,
              n = t.cmd;
            if ((a.wa && (g.cb = a.wa.ya), t.targetThread && t.targetThread != E())) {
              var r = g.xa[t.Jb];
              r
            ...
            } else if ("loaded" === n) (a.loaded = !0), o && o(a), a.Fa && (a.Fa(), delete a.Fa);
            else if ("print" === n) $("Thread " + t.threadId + ": " + t.text);
            else if ("printErr" === n) d("Thread " + t.threadId + ": " + t.text);
            else if ("alert" === n) alert("Thread " + t.threadId + ": " + t.text);
            else if ("exit" === n) a.wa && Atomics.load(C, (a.wa.ya + 64) >> 2) && g.La(a);
              ...
              "cancelDone" === n
                ? g.La(a)
                : "objectTransfer" !== n &&
                  ("setimmediate" === e.data.target ? a.postMessage(e.data) : d("worker sent an unknown command " + n));
            g.cb = void 0;
          }),
      ...
      function Me(e) {
        ...
        var a = e.Ba + e.Ca,
          o = (r = g.xa[e.Ka] = { worker: t, Ba: e.Ba, Ca: e.Ca, Pa: e.Pa, ya: e.Ka }).ya >> 2,
          i =
      ...
      function ke(e, t, n) {
        ...
        if (z) {
          ...
          for (n = performance.now() + n, Atomics.exchange(_, x >> 2, e); ; ) {
            if (n < performance.now()) return Atomics.exchange(_, x >> 2, 0), -73;
      ...
      function Ue(e) {
        return (e = 2 < e ? O(e) : e), qe[e] || ("undefined" != typeof document ? document.querySelector(e) : void 0);
      }
      function We(e, t, n) {
        var r,
          a,
            ...
            !s.Ya && s.zb
              ...
              : ((e = !1),
                (s = s.Ya ? s.Ya : s).Ia &&
                  s.Ia.Ha &&
                  (e =
                    0 === (e = s.Ia.Ha.getParameter(2978))[0] && 0 === e[1] && e[2] === s.width && e[3] === s.height),
                (s.width = t),
                (s.height = n),
        ...
        if (!c)
          if (t) e();
            ...
            try {
              ...
              if (e instanceof S) return;
              if ("unwind" !== e)
                throw (e && "object" == typeof e && e.stack && d("exception thrown: " + [e, e.stack]), e);
            }
            if (l && !he())
              try {
                (l ? Ft : zt)(ne);
      ...
      function Ye(r, n, a, o, t) {
        function i(e) {
          var t = 0,
            n = 0;
          e && ((n = v.response ? v.response.byteLength : 0), (t = P(n)), I.set(new Uint8Array(v.response), t)),
            (C[(r + 12) >> 2] = t),
            L(r + 16, n);
        }
        if ((p = C[(r + 8) >> 2])) {
          ...
          Ve.push(v),
            ...
            (v.onreadystatechange = function (e) {
              (D[(r + 40) >> 1] = v.readyState), 2 <= v.readyState && (D[(r + 42) >> 1] = v.status), t && t(r, v, e);
            });
          try {
            v.send(p);
          } catch (e) {
        ...
        if (a) {
          ...
          try {
            ...
            (i.onsuccess = function () {
              (D[(t + 40) >> 1] = 4), (D[(t + 42) >> 1] = 200), F("OK", I, t + 44, 64), n(t, 0, o);
            }),
              (i.onerror = function (e) {
                (D[(t + 40) >> 1] = 4), (D[(t + 42) >> 1] = 413), F("Payload Too Large", I, t + 44, 64), r(t, 0, e);
              });
          } catch (e) {
            r(t, 0, e);
          }
        ...
        return l
          ...
          : ((o = 0),
            Ze().forEach(function (e, t) {
              var n = a + o;
              for (t = _[(r + 4 * t) >> 2] = n, n = 0; n < e.length; ++n) h[t++ >> 0] = e.charCodeAt(n);
      ...
      function nt(e, t, n, r) {
        return l ? w(11, 1, e, t, n, r) : ((e = Ce.Cb(e)), (t = Ce.Bb(e, t, n)), (_[r >> 2] = t), 0);
      }
      ...
      function at(e, t, n, r) {
        ...
        for (var a = 0, o = 0; o < n; o++) {
          for (var i = _[(t + 8 * o) >> 2], s = _[(t + (8 * o + 4)) >> 2], u = 0; u < s; u++) {
            var c = I[i + u],
              f = De[e];
            0 === c || 10 === c ? ((1 === e ? $ : d)(se(f, 0)), (f.length = 0)) : f.push(c);
          }
          a += s;
        }
        return (_[r >> 2] = a), 0;
      ...
      function ft(e, t, n, r) {
        ...
        for (c in (f = {
          ...
          "%U": function (e) {
            ...
            return i(n, (e = new Date(e.V + 1900, e.Da, e.Ga))) < 0
              ? o(
                  Math.ceil(
                    (31 - n.getDate() + (it(ot(e.getFullYear()) ? st : ut, e.getMonth() - 1) - 31) + e.getDate()) / 7
                  ),
                  2
                )
              : 0 === i(n, t)
          ...
          "%V": function (e) {
            ...
            return i(r, n) < 0
              ...
              : i(t, r) <= 0
                ? "01"
                : o(
                    Math.ceil((n.getFullYear() < e.V + 1900 ? e.Oa + 32 - n.getDate() : e.Oa + 1 - n.getDate()) / 7),
                    2
                  );
          },
          "%w": function (e) {
        ...
        return (
          (l = n), (d = Array(ue(l) + 1)), F(l, d, 0, d.length), (c = d).length > t ? 0 : (h.set(c, e), c.length - 1)
        );
      }
      function lt(e) {
        try {
            ...
            0 === v
              ? ((a = r = !1),
                ...
                r ||
                  ...
                  (_[(e + 4) >> 2] = t + 4096),
                  (t = pt[0]),
                  void 0 === (n = mt[t]) && ((n = _t++), (mt[t] = n), (ht[n] = t)),
                  (_[(e + 8) >> 2] = n),
                  (b = e),
                  lt(function () {
                    i._asyncify_start_unwind(b);
                  }),
                  "undefined" != typeof Browser && Browser.Ra.Wa && Browser.Ra.pause()))
              : 2 === v
                ? ((v = 0),
      ...
      var At,
        ...
        xt = {
          c: function (e, t, n, r) {
            y(
              "Assertion failed: " + O(e) + ", at: " + [t ? O(t) : "unknown filename", n, r ? O(r) : "unknown function"]
            );
          },
          E: function (e, t) {
            St(e, t);
          ...
          L: function (e, t, n, r) {
            if ("undefined" == typeof SharedArrayBuffer)
              return d("Current environment does not support SharedArrayBuffer, pthreads are not available!"), 6;
            if (!e) return d("pthread_create called with a null thread pointer!"), 28;
            var a = [];
            ...
            var o,
              ...
              s = 0;
            t && -1 != t
              ? ((o = _[t >> 2]), (o += 81920), (i = _[(t + 8) >> 2]), (s = 0 !== _[(t + 12) >> 2]))
              : (o = 2097152),
            ...
            return (
              ...
              (_[(u + 12) >> 2] = u),
              (_[(e = u + 152) >> 2] = e),
              (n = { Ba: i, Ca: o, Pa: t, detached: s, ob: n, Ka: u, Ea: r, vb: a }),
          ...
          K: function (e, t) {
            var n = e,
              r = t;
            if (!n) return d("pthread_join attempted on a null thread pointer!"), 71;
            if (l && E() == n) return d("PThread " + n + " is attempting to join to itself!"), 16;
            if (!l && kt() == n) return d("Main thread " + n + " is attempting to join to itself!"), 16;
            if (_[(n + 12) >> 2] !== n)
              return (
                d(
            ...
            if (Atomics.load(C, (n + 64) >> 2))
              return d("Attempted to join thread " + n + ", which was already detached!"), 28;
            for (Te(); ; ) {
          ...
          O: function (e, t) {
            ...
            else if (l) postMessage({ targetThread: e, cmd: "processThreadQueue" });
            else {
          ...
          C: function (e, t) {
            ...
            return (_[t >> 2] = (e / 1e3) | 0), (_[(t + 4) >> 2] = ((e % 1e3) * 1e6) | 0), 0;
          },
          Q: function (e, t, n) {
            var r;
            for (Le.length = 0, n >>= 2; (r = I[t++]); )
              (r = r < 105) && 1 & n && n++, Le.push(r ? oe[n++ >> 1] : _[n]), ++n;
          ...
          m: function (e, n, t, r, a) {
            ...
            var f = e + 112,
              ...
              w = !!(16 & _),
              v = !!(64 & _);
            if ("EM_IDB_STORE" === l) (l = C[(f + 84) >> 2]), Ge(e, I.slice(l, l + C[(f + 88) >> 2]), c, s);
                ...
                try {
                  ...
                  (x.onsuccess = function (e) {
                    ...
                    (x.onerror = function (e) {
                      (D[(b + 40) >> 1] = 4), (D[(b + 42) >> 1] = 404), F("Not Found", I, b + 44, 64), E(b, 0, e);
                    });
                } catch (e) {
                  E(b, 0, e);
                }
                ...
                try {
                  ...
                  (T.onsuccess = function (e) {
                    ...
                    (T.onerror = function (e) {
                      (D[(S + 40) >> 1] = 4), (D[(S + 42) >> 1] = 404), F("Not Found", I, S + 44, 64), k(S, 0, e);
                    });
                } catch (e) {
                  k(S, 0, e);
                }
        ...
        St =
          (!(function () {
            function t(e, t) {
              (e = vt((e = e.exports))), (i.asm = e), de.unshift(i.asm.R), g.Ua.push(i.asm.U), (te = t), l || we();
            }
            function n(e) {
            ...
            (Z || "function" != typeof WebAssembly.instantiateStreaming || ve() || "function" != typeof fetch
              ? r(n)
              : fetch(p, { credentials: "same-origin" }).then(function (e) {
                  return WebAssembly.instantiateStreaming(e, a).then(n, function (e) {
                    return (
                      d("wasm streaming compile failed: " + e), d("falling back to ArrayBuffer instantiation"), r(n)
                    );
                  });
                })
            ).catch(k);
      ...
      function Gt(o) {
        function e() {
          if (!At && ((At = !0), (i.calledRun = !0), !c)) {
            if ((l || Ee(de), l || Ee(pe), M(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), Qt)) {
              var e = o,
      ...
      function zt(e) {
        if (((ne = e), l)) throw (postMessage({ cmd: "exitProcess", returnCode: e }), new S(e));
        he() || g.Sa(), (ne = e), he() || (g.Sa(), i.onExit && i.onExit(e), (c = !0)), Y(e, new S(e));
      }
      if (
      ...
      var Qt = !0;
      return i.noInitialRun && (Qt = !1), l && ((ee = !1), g.ib()), Gt(), e.ready;
    }
    var Kt;
  ...
  ("undefined" != typeof global &&
        ...
        (self.alert = function () {
          ...
          (self.onmessage = function (e) {
            try {
              if ("load" === e.data.cmd)
              ...
              else if ("objectTransfer" === e.data.cmd) a.PThread.receiveObjectTransfer(e.data);
                ...
                a.establishStackSpace(n, t), a.PThread.receiveObjectTransfer(e.data), a.PThread.threadInit();
                try {
                  ...
                  if ("Canceled!" === e) a.PThread.threadCancel();
                    ...
                    if (!(e instanceof a.ExitStatus)) throw (a.PThread.threadExit(-2), e);
                ...
                "cancel" === e.data.cmd
                  ...
                  : "setimmediate" !== e.data.target &&
                    ("processThreadQueue" === e.data.cmd
                      ? a._pthread_self() && a._emscripten_current_thread_process_queued_calls()
                      : (o("worker.js received unknown command " + e.data.cmd), o(e.data)));
            } catch (e) {
              throw (o("worker.js onmessage() captured an uncaught exception: " + e), e && e.stack && o(e.stack), e);
            }
          });
    ...
    : ("undefined" != typeof onmessage && ("undefined" == typeof window || void 0 === window.document)) ||
      ...
      ? ((r = "undefined" != typeof global && "[object process]" === Object.prototype.toString.call(global.process)),
        (a = []),
        r
          ? require.main === module
            ? ((t = require("path").join(__dirname, "stockfish-nnue-16.wasm")),
              ...
              require("readline")
                ...
                .on("line", function (e) {
                  e && (("quit" !== e && "exit" !== e) || process.exit(), n ? n.postMessage(e, !0) : a.push(e));
                })
                .on("close", function () {
                  process.exit();
                })
            ...
            (e = {
              locateFile: function (e) {
                return -1 < e.indexOf(".wasm")
                  ? t
                  : self.location.origin + self.location.pathname + "#" + t + ",worker";
              }
            }),
            i()(e)
              .then(function (t) {
