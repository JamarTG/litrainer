 ...
 */ !(function () {
  ...
  function i() {
    function e(e) {
      var i, D, I, n, t
      ;(e = e || {}),
        ((i = i || (void 0 !== e ? e : {})).ready = new Promise(function (e, n) {
          ;(D = e), (I = n)
        })),
                  ...
                  require('fs').readFile(t, function (e, n) {
                    ;(r.readyState = 4),
                      e
                        ...
                        : ((r.status = 200), (r.response = n), r.onreadystatechange(), r.onload())
                  })
                }
              }
            return r
        ...
        (i.postCustomMessage = function (e) {
          if ('undefined' != typeof PThread) for (var n of PThread.ba) n.postMessage({ cmd: 'custom', userData: e })
        }),
        (i.queue =
          ((t = []),
          {
      ...
      var A,
        ...
        a =
          ...
          (i.onCustomMessage = function (e) {
            return (
              'stop' === e || 'quit' === e ? i._stop() : 'ponderhit' === e && i._ponderhit(), i._origOnCustomMessage(e)
            )
          }),
          {})
        ...
        X =
          (G
            ? ((p = l ? require('path').dirname(p) + '/' : __dirname + '/'),
              ...
              (c = function (e) {
                return (e = (e = Y(e, !0)).buffer ? e : new Uint8Array(e)).buffer || w('Assertion failed: undefined'), e
              }),
            ...
            : (B || l) &&
              ...
              (p = 0 !== (p = We ? We : p).indexOf('blob:') ? p.substr(0, p.lastIndexOf('/') + 1) : ''),
              (Y = function (e) {
      ...
      var V = i.noExitRuntime || !0,
        m = ('object' != typeof WebAssembly && w('no native wasm support detected'), !1),
      ...
      function J(e) {
        for (var n = 0, t = 0; t < e.length; ++t) {
          ...
          ;(r = 55296 <= r && r <= 57343 ? (65536 + ((1023 & r) << 10)) | (1023 & e.charCodeAt(++t)) : r) <= 127
            ? ++n
      ...
      function ie() {
        ...
        v--,
          ...
          0 == v && (null !== oe && (clearInterval(oe), (oe = null)), _) && ((e = _), (_ = null), e())
      }
      function w(e) {
        throw (
      ...
      function de(r, t, o, a, n) {
        function i(e) {
          var n = 0,
            t = 0
          e && ((t = w.response ? w.response.byteLength : 0), (n = j(t)), R.set(new Uint8Array(w.response), n)),
            (T[(r + 12) >> 2] = n),
            U(r + 16, t)
        }
        if ((d = T[(r + 8) >> 2])) {
          ...
          pe.push(w),
            ...
            (w.onload = function (e) {
              ...
              U(r + 24, 0),
                ...
                200 <= w.status && w.status < 300 ? t && t(r, w, e) : o && o(r, w, e)
            }),
            ...
            (w.onprogress = function (e) {
              ...
              h && v && ((t = j(n)), R.set(new Uint8Array(w.response), t)),
                ...
                U(r + 32, e.total),
                (x[(r + 40) >> 1] = w.readyState),
                3 <= w.readyState && 0 === w.status && 0 < e.loaded && (w.status = 200),
                (x[(r + 42) >> 1] = w.status),
                w.statusText && O(w.statusText, R, r + 44, 64),
                a && a(r, w, e),
                t && Ue(t)
            ...
            (w.onreadystatechange = function (e) {
              ;(x[(r + 40) >> 1] = w.readyState), 2 <= w.readyState && (x[(r + 42) >> 1] = w.status), n && n(r, w, e)
            })
          try {
            w.send(d)
          } catch (e) {
      ...
      function me(n, e, t, r) {
        ...
        if (o) {
          ...
          try {
            var i = o.transaction(['FILES'], 'readwrite').objectStore('FILES').put(e, a)
            ;(i.onsuccess = function () {
              ;(x[(n + 40) >> 1] = 4), (x[(n + 42) >> 1] = 200), O('OK', R, n + 44, 64), t(n, 0, a)
            }),
              (i.onerror = function (e) {
                ;(x[(n + 40) >> 1] = 4), (x[(n + 42) >> 1] = 413), O('Payload Too Large', R, n + 44, 64), r(n, 0, e)
              })
          } catch (e) {
            r(n, 0, e)
          }
      ...
      function be(e, n, t, r) {
        ...
        function i(e, n) {
          ...
          var r
          return (r =
            0 === (r = t(e.getFullYear() - n.getFullYear())) && 0 === (r = t(e.getMonth() - n.getMonth()))
        ...
        function s(e) {
          ...
          var n = new Date(e.getFullYear() + 1, 0, 4),
            ...
            n = u(n)
          return i(t, e) <= 0 ? (i(n, e) <= 0 ? e.getFullYear() + 1 : e.getFullYear()) : e.getFullYear() - 1
        }
        var c,
          f = g[(r + 40) >> 2]
        for (c in ((r = {
        ...
        for (c in (f = {
          ...
          '%U': function (e) {
            ...
            return i(t, (e = new Date(e.F + 1900, e.M, e.N))) < 0
              ? a(
                  Math.ceil(
                    (31 - t.getDate() + (ve(S(e.getFullYear()) ? E : _e, e.getMonth() - 1) - 31) + e.getDate()) / 7
                  ),
                  2
                )
              : 0 === i(t, n)
          ...
          '%V': function (e) {
            ...
            return i(r, t) < 0
              ...
              : i(n, r) <= 0
                ? '01'
                : a(Math.ceil((t.getFullYear() < e.F + 1900 ? e.R + 32 - t.getDate() : e.R + 1 - t.getDate()) / 7), 2)
          },
          '%w': function (e) {
            return e.P
          },
          '%W': function (e) {
            var n = new Date(e.F, 0, 1),
              t = 1 === n.getDay() ? n : we(n, 0 === n.getDay() ? 1 : 7 - n.getDay() + 1)
            return i(t, (e = new Date(e.F + 1900, e.M, e.N))) < 0
              ? a(
                  Math.ceil(
                    (31 - t.getDate() + (ve(S(e.getFullYear()) ? E : _e, e.getMonth() - 1) - 31) + e.getDate()) / 7
        ...
        return (
          (l = t), (p = Array(J(l) + 1)), O(l, p, 0, p.length), (c = p).length > n ? 0 : (y.set(c, e), c.length - 1)
        )
      }
      function Se(e) {
        try {
                    ...
                    try {
                      ...
                      m ||
                        ...
                        F &&
                          1 === M &&
                          0 === Me.length &&
                          ((M = 0), Se(i._asyncify_stop_unwind), 'undefined' != typeof Fibers && Fibers.fa(), Ae) &&
                          (Ae(), (Ae = null)))
                    }
                  }
                : n
              ...
              ? ((r = t = !1),
                e(function (e) {
                  ...
                  !m &&
                    ...
                    'undefined' != typeof Browser && Browser.T.U && Browser.T.resume(),
                ...
                t ||
                  ...
                  (g[(e + 4) >> 2] = n + 4096),
                  (n = Me[0]),
                  void 0 === (o = Fe[n]) && ((o = Ie++), (Fe[n] = o), (De[o] = n)),
                  (g[(e + 8) >> 2] = o),
                  (F = e),
                  Se(function () {
                    i._asyncify_start_unwind(F)
                  }),
                  'undefined' != typeof Browser && Browser.T.U && Browser.T.pause()))
              : 2 === M
                ? ((M = 0),
      ...
      !(function (n) {
        ...
        ('undefined' != typeof ENVIRONMENT_IS_FETCH_WORKER && ENVIRONMENT_IS_FETCH_WORKER) || ae()
      var Te,
        Le = {
          f: function () {
            return 0
          ...
          j: function (e, t, n, r, o) {
            ...
            var f = e + 112,
              ...
              _ = !!(16 & g),
              w = !!(64 & g)
            if ('EM_IDB_STORE' === l) (l = T[(f + 84) >> 2]), me(e, R.slice(l, l + T[(f + 88) >> 2]), c, u)
              ...
              if (g) {
                ...
                f = C((f = f || T[(b + 8) >> 2]))
                try {
                  var M = g.transaction(['FILES'], 'readwrite').objectStore('FILES').delete(f)
                  ;(M.onsuccess = function (e) {
                    ...
                    (M.onerror = function (e) {
                      ;(x[(b + 40) >> 1] = 4), (x[(b + 42) >> 1] = 404), O('Not Found', R, b + 44, 64), E(b, 0, e)
                    })
                } catch (e) {
                  E(b, 0, e)
                }
              ...
              if (l) {
                ...
                g = C((g = g || T[(F + 8) >> 2]))
                try {
                  var A = l.transaction(['FILES'], 'readonly').objectStore('FILES').get(g)
                  ;(A.onsuccess = function (e) {
                    ...
                    (A.onerror = function (e) {
                      ;(x[(F + 40) >> 1] = 4), (x[(F + 42) >> 1] = 404), O('Not Found', R, F + 44, 64), I(F, 0, e)
                    })
                } catch (e) {
                  I(F, 0, e)
                }
          ...
          u: function (r, o) {
            ...
            return (
              he().forEach(function (e, n) {
                var t = o + a
                for (n = g[(r + 4 * n) >> 2] = t, t = 0; t < e.length; ++t) y[n++ >> 0] = e.charCodeAt(t)
          ...
          r: function (e, n, t, r) {
            for (var o = 0, a = 0; a < t; a++) {
              for (var i = g[(n + 8 * a) >> 2], u = g[(n + (8 * a + 4)) >> 2], s = 0; s < u; s++) {
                var c = R[i + s],
                  f = ce[e]
                0 === c || 10 === c ? ((1 === e ? X : d)(K(f, 0)), (f.length = 0)) : f.push(c)
              }
              o += u
            }
            return (g[r >> 2] = o), 0
        ...
        Ue =
          (!(function () {
            ...
            ;(f || 'function' != typeof WebAssembly.instantiateStreaming || ue() || 'function' != typeof fetch
              ? r(t)
              : fetch(h, { credentials: 'same-origin' }).then(function (e) {
                  return WebAssembly.instantiateStreaming(e, o).then(t, function (e) {
                    return (
                      d('wasm streaming compile failed: ' + e), d('falling back to ArrayBuffer instantiation'), r(t)
                    )
                  })
                })
            ).catch(I)
      ...
      function Ne(a) {
        function e() {
          if (!Te && ((Te = !0), (i.calledRun = !0), !m)) {
            if ((b(ee), b(ne), D(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), qe)) {
              var n = a,
                e = i._main,
                t = (n = n || []).length + 1,
                r = je(4 * (t + 1))
              ...
              try {
                ...
                e instanceof He ||
                  'unwind' == e ||
                  ((n = e) && 'object' == typeof e && e.stack && (n = [e, e.stack]),
      ...
      var qe = !0
      return i.noInitialRun && (qe = !1), Ne(), (i.onSpecialMessage = i.postCustomMessage), e.ready
    }
    var We
    ;(We = 'undefined' != typeof document && document.currentScript ? document.currentScript.src : void 0),
  ...
  ;('undefined' != typeof self && 'worker' === self.location.hash.split(',')[1]) ||
    ...
    ('undefined' != typeof global && '[object process]' === Object.prototype.toString.call(global.process))
      ? ((o = 'undefined' != typeof global && '[object process]' === Object.prototype.toString.call(global.process)),
        (a = []),
        o
          ? require.main === module
            ? ((r = require('path').join(__dirname, 'stockfish-nnue-16-single.wasm')),
              (e = {
              ...
              require('readline')
                ...
                .on('line', function (e) {
                  e && (('quit' !== e && 'exit' !== e) || process.exit(), t ? t.postMessage(e, !0) : a.push(e))
                })
                .on('close', function () {
                  process.exit()
                })
            ...
            : (module.exports = i)
          : ((n = function (e) {
              t.__IS_NON_NESTED__ || t.__IS_SINGLE_THREADED__ ? t.onCustomMessage(e) : t.postMessage(e, !0)
            }),
            (o = self.location.hash.substr(1).split(',')),
            (r = decodeURIComponent(o[0] || 'stockfish-nnue-16-single.wasm')),
            (e = {
              locateFile: function (e) {
                return -1 < e.indexOf('.wasm') ? r : self.location.origin + self.location.pathname + '#' + r + ',worker'
              }
            }),
            i()(e)
              .then(function (e) {
    ...
    (function (t, a) {
      ...
      function l() {
        function e(e) {
          e.source === t && 'string' == typeof e.data && 0 === e.data.indexOf(n) && f(+e.data.slice(n.length))
        }
                  ...
                  ? ((c = o.documentElement),
                    function (e) {
                      ...
                      ;(n.onreadystatechange = function () {
                        f(e), (n.onreadystatechange = null), c.removeChild(n), (n = null)
                      }),
                        c.appendChild(n)
                    })
                  : function (e) {
