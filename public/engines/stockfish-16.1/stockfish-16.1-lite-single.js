 ...
 */ !(function () {
  ...
  function o() {
    function e(e) {
      ;(e = e || {}),
        ((f = f || (void 0 !== e ? e : {})).ready = new Promise(function (e, n) {
          ;(T = e), (i = n)
        })),
        ...
        L =
          (q
            ? ((p = l ? require('path').dirname(p) + '/' : __dirname + '/'),
              ...
              (n = function (e, n) {
                return H(), (e = r.normalize(e)), U.readFileSync(e, n ? void 0 : 'utf8')
              }),
              ...
              (c = (e, n) => {
                ...
                n instanceof j || d('exiting due to exception: ' + n), process.exit(e)
              }),
              (f.inspect = function () {
      ...
      var W,
        ...
        g,
        v = !1,
        N = 'undefined' != typeof TextDecoder ? new TextDecoder('utf8') : void 0
      function J(e, n, t) {
        var r = n + t
        for (t = n; e[t] && !(r <= t); ) ++t
      ...
      function z(e, n, t, r) {
        if (0 < r) {
          ...
          for (var o = 0; o < e.length; ++o) {
            ...
            if ((i = 55296 <= i && i <= 57343 ? (65536 + ((1023 & i) << 10)) | (1023 & e.charCodeAt(++o)) : i) <= 127) {
              if (r <= t) break
              n[t++] = i
            } else {
              if (i <= 2047) {
      ...
      function me(e, n, t, r) {
        ...
        function s(e) {
          ...
          var n = new Date(e.getFullYear() + 1, 0, 4),
            ...
            n = u(n)
          return a(t, e) <= 0 ? (a(n, e) <= 0 ? e.getFullYear() + 1 : e.getFullYear()) : e.getFullYear() - 1
        }
        var c,
          l = g[(r + 40) >> 2]
        for (c in ((r = {
          ...
          l = {
            ...
            '%U': function (e) {
              ...
              return a(t, (e = new Date(e.I + 1900, e.J, e.K))) < 0
                ? i(
                    Math.ceil(
                      (31 - t.getDate() + (de(A(e.getFullYear()) ? I : R, e.getMonth() - 1) - 31) + e.getDate()) / 7
                    ),
                    2
                  )
                : 0 === a(t, n)
            ...
            '%V': function (e) {
              ...
              return a(r, t) < 0
                ...
                : a(n, r) <= 0
                  ? '01'
                  : i(Math.ceil((t.getFullYear() < e.I + 1900 ? e.N + 32 - t.getDate() : e.N + 1 - t.getDate()) / 7), 2)
            },
            '%w': function (e) {
              return e.M
            },
            '%W': function (e) {
              var n = new Date(e.I, 0, 1),
                t = 1 === n.getDay() ? n : M(n, 0 === n.getDay() ? 1 : 7 - n.getDay() + 1)
              return a(t, (e = new Date(e.I + 1900, e.J, e.K))) < 0
                ? i(
                    Math.ceil(
                      (31 - t.getDate() + (de(A(e.getFullYear()) ? I : R, e.getMonth() - 1) - 31) + e.getDate()) / 7
        ...
        for (c in ((t = t.replace(/%%/g, '\0\0')), l)) t.includes(c) && (t = t.replace(new RegExp(c, 'g'), l[c](r)))
        return (
          (t = t.replace(/\0\0/g, '%')),
          (f = t),
          (p = Array(G(f) + 1)),
                    ...
                    try {
                      ...
                      v ||
                        ...
                        E &&
                          1 === F &&
                          0 === O.length &&
                          ((F = 0), x(f._asyncify_stop_unwind), 'undefined' != typeof Fibers) &&
                          Fibers.$())
                    }
                  }
                : n
              ...
              e(() => {
                if (!v && ((o = !0), i)) {
                  ;(F = 2),
                    ...
                    'undefined' != typeof Browser && Browser.P.R && Browser.P.resume()
                  var n = !1
                  try {
                  ...
                  var e,
                    r = !1
                  if ((E || ((e = ve) && ((ve = null), (n ? e.reject : e.resolve)(t), (r = !0))), n && !r)) throw t
                }
              }),
              (i = !0),
              o ||
                ...
                (g[(e + 4) >> 2] = n + 10485760),
                (n = O[0]),
                void 0 === (t = ye[n]) && ((t = ge++), (ye[n] = t), (he[t] = n)),
                (g[(e + 8) >> 2] = t),
                (E = e),
                x(() => f._asyncify_start_unwind(E)),
                'undefined' != typeof Browser && Browser.P.R && Browser.P.pause()))
            : 2 === F
              ? ((F = 0), x(f._asyncify_stop_rewind), Ce(E), (E = null), we.forEach((e) => se(e)))
              : C('invalid state: ' + F))
      }
      var P,
        Se = {
          ...
          p: function (e, n, t, r) {
            for (var o = 0, i = 0; i < t; i++) {
              ...
              for (var s = 0; s < u; s++) {
                var c = h[a + s],
                  l = ae[e]
                0 === c || 10 === c ? ((1 === e ? L : d)(J(l, 0)), (l.length = 0)) : l.push(c)
              }
              o += u
            }
            return (g[r >> 2] = o), 0
          ...
          (!(function () {
            function n(e) {
              ;(e = _e((e = e.exports))),
                ...
                0 == b && (null !== te && (clearInterval(te), (te = null)), S) && ((e = S), (S = null), e())
            }
            function t(e) {
              n(e.instance)
            }
            ...
            var o = { a: Se }
            if ((b++, f.monitorRunDependencies && f.monitorRunDependencies(b), f.instantiateWasm))
              try {
            ...
            ;(a || 'function' != typeof WebAssembly.instantiateStreaming || re() || 'function' != typeof fetch
              ? r(t)
      ...
      function Fe(i) {
        function e() {
          if (!P && ((P = !0), (f.calledRun = !0), !v)) {
            if ((D($), D(Q), T(f), f.onRuntimeInitialized && f.onRuntimeInitialized(), Oe)) {
              var e = i,
                n = f._main,
                t = (e = e || []).length + 1,
                r = Y(4 * (t + 1))
      ...
      function Ee(e) {
        m || 0 < _ || (ne = !0), m || 0 < _ || (f.onExit && f.onExit(e), (v = !0)), c(e, new j(e))
      }
      if (
        ...
        (f.ccall = function (e, n, t, r, o) {
          function i(e) {
            return --_, 0 !== s && Re(s), 'string' === n ? X(e) : 'boolean' === n ? !!e : e
          }
          var a = {
              string: function (e) {
                var n,
                  t = 0
                return null != e && 0 !== e && ((n = 1 + (e.length << 2)), (t = Y(n)), z(e, h, t, n)), t
              },
              array: function (e) {
                var n = Y(e.length)
                return y.set(e, n), n
    ...
    var Pe
    ;(Pe = 'undefined' != typeof document && document.currentScript ? document.currentScript.src : void 0),
        ...
        e
            ...
            ? ((s = require('path')),
              ...
              (t = {
                locateFile: function (e) {
                  return -1 < e.indexOf('.wasm') ? (-1 < e.indexOf('.wasm.map') ? a + '.map' : a) : __filename
                },
                listener: function (e) {
              ...
              'number' == typeof enginePartsCount &&
                (t.wasmBinary = (function (e) {
                  for (var n = require('fs'), t = s.extname(a), r = a.slice(0, -t.length), o = [], i = 0; i < e; ++i)
              ...
              require('readline')
                ...
                .on('line', function (e) {
                  e && (t.sendCommand ? t.sendCommand(e) : r.push(e), ('quit' !== e && 'exit' !== e) || process.exit())
                })
                .on('close', function () {
                  process.exit()
                })
          ...
          : ((e = self.location.hash.substr(1).split(',')),
            ...
            (onmessage =
              onmessage ||
              function (e) {
                if ((t.sendCommand ? t.sendCommand(e.data) : r.push(e.data), 'quit' === e.data || 'exit' === e.data))
                  try {
                    self.close()
                  } catch (e) {}
              })))
